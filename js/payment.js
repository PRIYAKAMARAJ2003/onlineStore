    ...
    $(document).ready(function() {
        ...
        $('.menu-toggle').click(function() {
            ...
            if ($('#sidebar').is(':visible')) {
                ...
                $.ajax({
                    url: 'https://firestore.googleapis.com/v1/projects/onlinestore-229ef/databases/(default)/documents/Customer',
                    type: 'GET',
        ...
        function displayCustomerInfo(customerInfo) {
            if (customerInfo.length > 0) {
                ...
                const fullName = customerData.name.stringValue;
                const contact = customerData.mobile.stringValue;
        ...
        $.ajax({
            url: 'https://firestore.googleapis.com/v1/projects/onlinestore-229ef/databases/(default)/documents/Inventory',
            type: 'GET',
            success: function(response) {
        ...
        function addToCart(productName, productPrice, productQuantity) {
            ...
            if (existingCartItem.length > 0) {
                ...
                if (confirm(`Add ${productName} to cart for Rs.${productPrice}?`)) {
        ...
        $('#paymentButton').click('click', function() {
...
function processCreditPayment() {
    ...
    const customerId = "VTgOhgNkIOKYgBMZQClZ";
    if (customerId) {
        $.ajax({
            url: `https://firestore.googleapis.com/v1/projects/onlinestore-229ef/databases/(default)/documents/Customer/${customerId}`,
            type: 'GET',
            success: function(response) {
    ...
    $.ajax({
       ...
       // Function to update inventory
                    ...
                    inventoryItems.forEach(inventoryItem => {
                        ...
                        if (cartProduct) {
                            ...
                            if (newQuantity >= 0) {
                                ...
                                $.ajax({
                                    url: `https://firestore.googleapis.com/v1/projects/onlinestore-229ef/databases/(default)/documents/Inventory/${inventoryId}`,
                                    type: 'PATCH',
                                    contentType: 'application/json',
                                    data: JSON.stringify({
        ...
        function createOrder(paymentMethod) {
            ...
            const customerId = "VTgOhgNkIOKYgBMZQClZ"; // Replace this with the actual customer ID
            ...
            $.ajax({
                url: `https://firestore.googleapis.com/v1/projects/onlinestore-229ef/databases/(default)/documents/OrderDetails`,
                type: 'POST',
                contentType: 'application/json',
