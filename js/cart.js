...
//         // Send the data to the cart endpoint
//         fetch('https://firestore.googleapis.com/v1/projects/onlinestore-229ef/databases/(default)/documents/Cart', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json'
//             },
//             body: JSON.stringify({ fields: cartData })
//         })
//         .then(response => {
//             if (!response.ok) {
...
//             // Get the product details from button attributes
//             // let productName = button.parentNode.parentNode.querySelector('.product-price').textContent.split('\n')[0];
//             // let productImage = button.parentNode.parentNode.querySelector('.product-img').getAttribute('src');
//             // let productPrice = button.parentNode.parentNode.querySelector('.product-price').textContent.split('Rs.')[1];
    ...
    $(document).ready(function() {
       ...
       // Function to update inventory
        ...
        function createOrder() {
            ...
            $.ajax({
                url: 'https://firestore.googleapis.com/v1/projects/onlinestore-2e219/databases/(default)/documents/Purchase',
                type: 'POST',
                contentType: 'application/json',
